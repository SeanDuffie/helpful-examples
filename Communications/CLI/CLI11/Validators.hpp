...
// class Datapath_Validator : public Validator {
//     public:
//         Datapath_Validator() : Validator("FILE") {
//             name_ = "DATA";
//             func_ = [](std::string &filename) {
//                 std::string datapath = get_current_dir_name();   /** Path to data directory */
//                 datapath.append("/data/");
//                 auto path_result = check_path((datapath+filename).c_str());
